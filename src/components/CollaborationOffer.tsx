...
import { collections3json } from "../data/offerDetails";
...
const CollaborationOffer = () => {
  ...
  const visibleProducts = isExpanded ? collections3json : collections3json.slice(0, INITIAL_VISIBLE_COUNT);

  return (
    <section ref={sectionRef} id="CollaborationOffer" className="pt-6 pb-12 px-4 max-w-7xl mx-auto scroll-mt-24">
      ...
      {collections3json.length > INITIAL_VISIBLE_COUNT && (
...
export default CollaborationOffer;
