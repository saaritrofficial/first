...
import { collections } from "../data/ProductDetails";
...
const Collections = () => {
  ...
  const visibleProducts = isExpanded ? collections : collections.slice(0, INITIAL_VISIBLE_COUNT);

  return (
    /* FIXED: Tightened layout grid parameters from py-20 to pt-8 pb-16 */
    <section ref={sectionRef} id="collections" className="pt-8 pb-16 px-4 max-w-7xl mx-auto scroll-mt-24">
