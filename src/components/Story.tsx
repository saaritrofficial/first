      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="text-[#2D2D2D] max-w-3xl mx-auto text-lg leading-relaxed font-medium space-y-5">
            <p>
              SAAR was created with a simple belief that fragrance should feel personal, powerful, and rooted in identity. Inspired by India's rich perfumery heritage, especially the timeless traditions of Kannauj, SAAR blends cultural depth with modern refinement.
            </p>
            <p>
              Our fragrances are thoughtfully curated to suit Indian preferences, climate, and lifestyle and offering long-lasting performance with a premium feel. We don't just create perfumes. We create presence.
            </p>
            <p>
              In a world of fast trends and fleeting impressions, SAAR was born to bring back depth and meaning to fragrance. India has a rich legacy of perfumery, where fragrance has always been more than a luxury and has remained deeply connected to culture, rituals, and identity
            </p>
            <p>
